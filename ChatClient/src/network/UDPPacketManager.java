...
public class UDPPacketManager implements CommManager{
	...
	/**
	 * Remove any message that exists in the message cache with the input id. 
	 * @param id The message id that you want removed from the cache. 
	 */
	...
	public void clearMsgCache()
	{
		...
		//Iterate through the map. If an entry has been there longer than 60 secs,
		//dispose of it.
		while (iter.hasNext()) {
